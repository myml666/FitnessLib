...
import static com.itfitness.fitnesslib.widget.industry.PagerConfig.Loge;
import static com.itfitness.fitnesslib.widget.industry.PagerConfig.Logi;

/**
 * @ProjectName: IndustryView
 * @Package: com.itfitness.industryview.widget
 * @ClassName: PagerGridLayoutManager
 * @Description: java类作用描述
 * @Author: 作者名
 * @CreateDate: 2020/9/13 16:16
 * @UpdateUser: 更新者：itfitness
 * @UpdateDate: 2020/9/13 16:16
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
public class PagerGridLayoutManager  extends RecyclerView.LayoutManager
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getItemCount(); i++) {
            ...
            if(height < mMeasuredDimension[1]){
     ...
     */
    @PagerGridLayoutManager.OrientationType
    public int setOrientationType(@PagerGridLayoutManager.OrientationType int orientation) {
    ...
    private PagerGridLayoutManager.PageListener mPageListener = null;
