 ...
 * @Author: 作者名
 * @CreateDate: 2020/9/16 22:25
 * @UpdateUser: 更新者：itfitness
 * @UpdateDate: 2020/9/16 22:25
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
public class LoadMoreFooterView extends FrameLayout implements IBottomView {
    ...
    public void onPullingUp(float fraction, float maxHeadHeight, float headHeight) {
        LogUtils.eTag("上拉1",fraction,headHeight,maxHeadHeight);
    ...
    public void onPullReleasing(float fraction, float maxHeadHeight, float headHeight) {
        LogUtils.eTag("上拉2",fraction,headHeight,maxHeadHeight);
        if (fraction < 1f) {
